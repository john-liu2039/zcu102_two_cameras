...
entity bd_c7bd_vsc_0_MultiPixStream2AXIvi is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of bd_c7bd_vsc_0_MultiPixStream2AXIvi is 
...
begin
    grp_reg_unsigned_short_s_fu_307 : component bd_c7bd_vsc_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_313 : component bd_c7bd_vsc_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
