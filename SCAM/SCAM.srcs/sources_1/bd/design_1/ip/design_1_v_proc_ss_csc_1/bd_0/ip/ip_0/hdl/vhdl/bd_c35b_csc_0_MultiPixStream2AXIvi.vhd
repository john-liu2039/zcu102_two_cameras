...
entity bd_c35b_csc_0_MultiPixStream2AXIvi is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of bd_c35b_csc_0_MultiPixStream2AXIvi is 
    ...
    component bd_c35b_csc_0_reg_unsigned_short_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_reg_unsigned_short_s_fu_289 : component bd_c35b_csc_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_295 : component bd_c35b_csc_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
