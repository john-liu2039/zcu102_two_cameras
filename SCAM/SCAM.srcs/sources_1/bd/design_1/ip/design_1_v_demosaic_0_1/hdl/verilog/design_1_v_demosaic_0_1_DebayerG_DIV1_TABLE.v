...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module design_1_v_demosaic_0_1_DebayerG_DIV1_TABLE_rom (
...
initial begin
    $readmemh("./design_1_v_demosaic_0_1_DebayerG_DIV1_TABLE_rom.dat", ram0);
    $readmemh("./design_1_v_demosaic_0_1_DebayerG_DIV1_TABLE_rom.dat", ram1);
    $readmemh("./design_1_v_demosaic_0_1_DebayerG_DIV1_TABLE_rom.dat", ram2);
    $readmemh("./design_1_v_demosaic_0_1_DebayerG_DIV1_TABLE_rom.dat", ram3);
end
