...
module bd_077c_hsc_0_v_hscaler_entry334 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        HwReg_ColorMode_c32_din,
        HwReg_ColorMode_c32_full_n,
        HwReg_ColorMode_c32_write,
        HwReg_ColorMode_c33_din,
        HwReg_ColorMode_c33_full_n,
        HwReg_ColorMode_c33_write,
        HwReg_ColorModeOut_c_din,
        HwReg_ColorModeOut_c_full_n,
        HwReg_ColorModeOut_c_write,
        HwReg_ColorModeOut_c_2_din,
        HwReg_ColorModeOut_c_2_full_n,
        HwReg_ColorModeOut_c_2_write,
...
output  [7:0] HwReg_ColorMode_c32_din;
input   HwReg_ColorMode_c32_full_n;
output   HwReg_ColorMode_c32_write;
output  [7:0] HwReg_ColorMode_c33_din;
input   HwReg_ColorMode_c33_full_n;
output   HwReg_ColorMode_c33_write;
output  [7:0] HwReg_ColorModeOut_c_din;
input   HwReg_ColorModeOut_c_full_n;
output   HwReg_ColorModeOut_c_write;
output  [7:0] HwReg_ColorModeOut_c_2_din;
input   HwReg_ColorModeOut_c_2_full_n;
output   HwReg_ColorModeOut_c_2_write;
...
reg HwReg_ColorMode_c32_write;
reg HwReg_ColorMode_c33_write;
reg HwReg_ColorModeOut_c_write;
reg HwReg_ColorModeOut_c_2_write;
...
reg    HwReg_ColorMode_c32_blk_n;
reg    HwReg_ColorMode_c33_blk_n;
reg    HwReg_ColorModeOut_c_blk_n;
reg    HwReg_ColorModeOut_c_2_blk_n;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((1'b0 == HwReg_ColorModeOut_c_1_full_n) | (1'b0 == HwReg_ColorModeOut_c_2_full_n) | (1'b0 == real_start) | (1'b0 == HwReg_ColorModeOut_c_full_n) | (1'b0 == HwReg_ColorMode_c33_full_n) | (1'b0 == HwReg_ColorMode_c32_full_n) | (1'b0 == HwReg_ColorMode_c_full_n) | (1'b0 == HwReg_WidthOut_c_full_n) | (1'b0 == HwReg_WidthIn_c_full_n) | (1'b0 == HwReg_Height_c_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((1'b0 == HwReg_ColorModeOut_c_1_full_n) | (1'b0 == HwReg_ColorModeOut_c_2_full_n) | (1'b0 == real_start) | (1'b0 == HwReg_ColorModeOut_c_full_n) | (1'b0 == HwReg_ColorMode_c33_full_n) | (1'b0 == HwReg_ColorMode_c32_full_n) | (1'b0 == HwReg_ColorMode_c_full_n) | (1'b0 == HwReg_WidthOut_c_full_n) | (1'b0 == HwReg_WidthIn_c_full_n) | (1'b0 == HwReg_Height_c_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        HwReg_ColorModeOut_c_2_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((1'b0 == HwReg_ColorModeOut_c_1_full_n) | (1'b0 == HwReg_ColorModeOut_c_2_full_n) | (1'b0 == real_start) | (1'b0 == HwReg_ColorModeOut_c_full_n) | (1'b0 == HwReg_ColorMode_c33_full_n) | (1'b0 == HwReg_ColorMode_c32_full_n) | (1'b0 == HwReg_ColorMode_c_full_n) | (1'b0 == HwReg_WidthOut_c_full_n) | (1'b0 == HwReg_WidthIn_c_full_n) | (1'b0 == HwReg_Height_c_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_ColorModeOut_c_2_write = 1'b1;
    end else begin
        HwReg_ColorModeOut_c_2_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        HwReg_ColorMode_c32_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((1'b0 == HwReg_ColorModeOut_c_1_full_n) | (1'b0 == HwReg_ColorModeOut_c_2_full_n) | (1'b0 == real_start) | (1'b0 == HwReg_ColorModeOut_c_full_n) | (1'b0 == HwReg_ColorMode_c33_full_n) | (1'b0 == HwReg_ColorMode_c32_full_n) | (1'b0 == HwReg_ColorMode_c_full_n) | (1'b0 == HwReg_WidthOut_c_full_n) | (1'b0 == HwReg_WidthIn_c_full_n) | (1'b0 == HwReg_Height_c_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_ColorMode_c32_write = 1'b1;
    end else begin
        HwReg_ColorMode_c32_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        HwReg_ColorMode_c33_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((1'b0 == HwReg_ColorModeOut_c_1_full_n) | (1'b0 == HwReg_ColorModeOut_c_2_full_n) | (1'b0 == real_start) | (1'b0 == HwReg_ColorModeOut_c_full_n) | (1'b0 == HwReg_ColorMode_c33_full_n) | (1'b0 == HwReg_ColorMode_c32_full_n) | (1'b0 == HwReg_ColorMode_c_full_n) | (1'b0 == HwReg_WidthOut_c_full_n) | (1'b0 == HwReg_WidthIn_c_full_n) | (1'b0 == HwReg_Height_c_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_ColorMode_c33_write = 1'b1;
    end else begin
        HwReg_ColorMode_c33_write = 1'b0;
    end
end
...
assign HwReg_ColorModeOut_c_2_din = HwReg_ColorModeOut;

assign HwReg_ColorModeOut_c_din = HwReg_ColorModeOut;

assign HwReg_ColorMode_c32_din = HwReg_ColorMode;

assign HwReg_ColorMode_c33_din = HwReg_ColorMode;
...
always @ (*) begin
    ap_block_state1 = ((1'b0 == HwReg_ColorModeOut_c_1_full_n) | (1'b0 == HwReg_ColorModeOut_c_2_full_n) | (1'b0 == real_start) | (1'b0 == HwReg_ColorModeOut_c_full_n) | (1'b0 == HwReg_ColorMode_c33_full_n) | (1'b0 == HwReg_ColorMode_c32_full_n) | (1'b0 == HwReg_ColorMode_c_full_n) | (1'b0 == HwReg_WidthOut_c_full_n) | (1'b0 == HwReg_WidthIn_c_full_n) | (1'b0 == HwReg_Height_c_full_n) | (ap_done_reg == 1'b1));
end
...
endmodule //bd_077c_hsc_0_v_hscaler_entry334
