...
entity bd_077c_hsc_0_hscale_core_polyppcA_rom is 
    generic(
             dwidth     : integer := 2; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of bd_077c_hsc_0_hscale_core_polyppcA_rom is 
...
entity bd_077c_hsc_0_hscale_core_polyppcA is
    generic (
        DataWidth : INTEGER := 2;
...
architecture arch of bd_077c_hsc_0_hscale_core_polyppcA is
    component bd_077c_hsc_0_hscale_core_polyppcA_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    bd_077c_hsc_0_hscale_core_polyppcA_rom_U :  component bd_077c_hsc_0_hscale_core_polyppcA_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
