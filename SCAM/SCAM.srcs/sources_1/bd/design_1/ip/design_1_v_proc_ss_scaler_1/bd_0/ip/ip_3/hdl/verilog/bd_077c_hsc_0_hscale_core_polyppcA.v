...
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module bd_077c_hsc_0_hscale_core_polyppcA_rom (
...
initial begin
    $readmemh("./bd_077c_hsc_0_hscale_core_polyppcA_rom.dat", ram0);
    $readmemh("./bd_077c_hsc_0_hscale_core_polyppcA_rom.dat", ram1);
    $readmemh("./bd_077c_hsc_0_hscale_core_polyppcA_rom.dat", ram2);
end
...
`timescale 1 ns / 1 ps
module bd_077c_hsc_0_hscale_core_polyppcA(
    reset,
    clk,
    address0,
    ce0,
...
bd_077c_hsc_0_hscale_core_polyppcA_rom bd_077c_hsc_0_hscale_core_polyppcA_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
