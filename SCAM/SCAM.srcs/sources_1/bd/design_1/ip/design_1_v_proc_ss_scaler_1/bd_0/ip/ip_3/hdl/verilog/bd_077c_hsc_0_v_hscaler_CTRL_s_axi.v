...
`timescale 1ns/1ps
module bd_077c_hsc_0_v_hscaler_CTRL_s_axi
#(parameter
    ...
    output wire [17:0]                   HwReg_phasesH_V_q0,
...
//------------------------Instantiation------------------
// int_HwReg_hfltCoeff
bd_077c_hsc_0_v_hscaler_CTRL_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 256 )
) int_HwReg_hfltCoeff (
    .clk0     ( ACLK ),
...
// HwReg_phasesH_V
assign int_HwReg_phasesH_V_address0 = HwReg_phasesH_V_address0;
...
assign HwReg_phasesH_V_q0           = int_HwReg_phasesH_V_q0;
...
module bd_077c_hsc_0_v_hscaler_CTRL_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
