...
module bd_039a_csc_0_AXIvideo2MultiPixStr (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        stream_in_V_val_3_V_full_n,
        stream_in_V_val_3_V_write,
        stream_in_V_val_4_V_din,
        stream_in_V_val_4_V_full_n,
        stream_in_V_val_4_V_write,
        stream_in_V_val_5_V_din,
        stream_in_V_val_5_V_full_n,
        stream_in_V_val_5_V_write,
        HwReg_height,
        HwReg_width,
        HwReg_InVideoFormat
);
...
output  [7:0] stream_in_V_val_3_V_din;
input   stream_in_V_val_3_V_full_n;
output   stream_in_V_val_3_V_write;
output  [7:0] stream_in_V_val_4_V_din;
input   stream_in_V_val_4_V_full_n;
output   stream_in_V_val_4_V_write;
output  [7:0] stream_in_V_val_5_V_din;
input   stream_in_V_val_5_V_full_n;
output   stream_in_V_val_5_V_write;
...
reg   [0:0] exitcond_i_reg_692;
reg   [0:0] brmerge_i_i_reg_701;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter1;
wire    ap_block_pp2_stage0;
reg   [0:0] eol_2_i_i_reg_363;
reg    stream_in_V_val_0_V_blk_n;
reg    stream_in_V_val_1_V_blk_n;
reg    stream_in_V_val_2_V_blk_n;
reg    stream_in_V_val_3_V_blk_n;
reg    stream_in_V_val_4_V_blk_n;
reg    stream_in_V_val_5_V_blk_n;
reg   [0:0] eol_i_i_reg_293;
reg   [10:0] j_i_i_reg_305;
reg   [0:0] eol_reg_316;
reg   [47:0] axi_data_V_1_i_i_reg_327;
reg   [0:0] axi_last_V_3_i_i_reg_374;
reg   [47:0] axi_data_V_3_i_i_reg_386;
reg    ap_block_state1;
wire    ap_CS_fsm_state2;
wire    grp_reg_unsigned_short_s_fu_416_ap_done;
wire    grp_reg_unsigned_short_s_fu_422_ap_done;
reg    ap_block_state2_on_subcall_done;
wire   [11:0] grp_reg_unsigned_short_s_fu_416_ap_return;
reg   [11:0] tmp_i_i_reg_631;
wire   [11:0] grp_reg_unsigned_short_s_fu_422_ap_return;
reg   [11:0] tmp_i_i_75_reg_636;
reg   [47:0] tmp_data_V_reg_641;
reg   [0:0] tmp_last_V_reg_649;
reg   [10:0] tmp_i_reg_661;
wire    ap_CS_fsm_state4;
wire   [0:0] sel_tmp_i_fu_441_p2;
wire   [0:0] sel_tmp2_i_fu_446_p2;
wire   [0:0] exitcond3_i_i_fu_456_p2;
wire    ap_CS_fsm_state5;
wire   [11:0] i_fu_461_p2;
reg   [11:0] i_reg_687;
wire   [0:0] exitcond_i_fu_467_p2;
wire    ap_block_state6_pp1_stage0_iter0;
reg    ap_predicate_op72_read_state7;
wire    stream_in_V_val_0_V1_status;
reg    ap_block_state7_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [10:0] j_fu_472_p2;
...
reg   [0:0] ap_phi_mux_eol_2_i_i_phi_fu_366_p4;
wire    grp_reg_unsigned_short_s_fu_416_ap_start;
wire    grp_reg_unsigned_short_s_fu_416_ap_idle;
wire    grp_reg_unsigned_short_s_fu_416_ap_ready;
wire   [11:0] grp_reg_unsigned_short_s_fu_416_in_r;
wire    grp_reg_unsigned_short_s_fu_422_ap_start;
wire    grp_reg_unsigned_short_s_fu_422_ap_idle;
wire    grp_reg_unsigned_short_s_fu_422_ap_ready;
wire   [11:0] grp_reg_unsigned_short_s_fu_422_in_r;
reg   [0:0] axi_last_V1_i_i_reg_262;
wire    ap_CS_fsm_state11;
reg   [47:0] axi_data_V1_i_i_reg_272;
reg   [11:0] i_i_i_reg_282;
reg   [0:0] ap_phi_mux_eol_i_i_phi_fu_297_p4;
reg   [0:0] ap_phi_mux_axi_last_V_2_i_i_phi_fu_343_p4;
reg   [47:0] ap_phi_mux_p_Val2_s_phi_fu_355_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_i_i_reg_338;
wire   [47:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_351;
reg    ap_reg_grp_reg_unsigned_short_s_fu_416_ap_start;
reg    ap_block_state1_ignore_call12;
reg    ap_reg_grp_reg_unsigned_short_s_fu_422_ap_start;
reg    ap_block_state1_ignore_call13;
reg    stream_in_V_val_0_V1_update;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_i_fu_200;
wire   [7:0] pix_val_3_V_fu_516_p4;
wire   [7:0] pix_val_5_V_fu_536_p4;
wire   [7:0] sel_tmp1_i_fu_546_p3;
wire   [7:0] pix_val_4_V_1_fu_526_p4;
wire   [7:0] sel_tmp5_i_fu_561_p3;
wire   [7:0] pix_val_0_V_fu_492_p4;
wire   [7:0] sel_tmp9_i_fu_576_p3;
wire   [7:0] pix_val_2_V_fu_506_p4;
wire   [7:0] pix_val_1_V_1_fu_502_p1;
wire   [0:0] tmp_user_V_fu_428_p1;
reg   [8:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
reg    ap_idle_pp2;
...
#0 ap_reg_grp_reg_unsigned_short_s_fu_416_ap_start = 1'b0;
#0 ap_reg_grp_reg_unsigned_short_s_fu_422_ap_start = 1'b0;
end

bd_039a_csc_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_416(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
bd_039a_csc_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_422(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'd1 == exitcond3_i_i_fu_456_p2) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_block_pp1_stage0_subdone == 1'b0) & (1'd1 == exitcond_i_fu_467_p2) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((1'd0 == exitcond3_i_i_fu_456_p2) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_block_pp2_stage0_subdone == 1'b0) & (1'd1 == ap_phi_mux_eol_2_i_i_phi_fu_366_p4) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_grp_reg_unsigned_short_s_fu_416_ap_start <= 1'b0;
    end else begin
        if ((~((1'b0 == ap_start) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_reg_grp_reg_unsigned_short_s_fu_416_ap_start <= 1'b1;
        end else if ((1'b1 == grp_reg_unsigned_short_s_fu_416_ap_ready)) begin
            ap_reg_grp_reg_unsigned_short_s_fu_416_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_grp_reg_unsigned_short_s_fu_422_ap_start <= 1'b0;
    end else begin
        if ((~((1'b0 == ap_start) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_reg_grp_reg_unsigned_short_s_fu_422_ap_start <= 1'b1;
        end else if ((1'b1 == grp_reg_unsigned_short_s_fu_422_ap_ready)) begin
            ap_reg_grp_reg_unsigned_short_s_fu_422_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_block_pp1_stage0_11001 == 1'b0) & (1'd0 == exitcond_i_reg_692) & (1'b1 == ap_enable_reg_pp1_iter1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((ap_block_pp2_stage0_11001 == 1'b0) & (1'd0 == eol_2_i_i_reg_363) & (1'b1 == ap_enable_reg_pp2_iter1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_block_pp1_stage0_11001 == 1'b0) & (1'd0 == exitcond_i_fu_467_p2) & (1'b1 == ap_enable_reg_pp1_iter0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_block_pp1_stage0_11001 == 1'b0) & (1'd0 == exitcond_i_fu_467_p2) & (1'b1 == ap_enable_reg_pp1_iter0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_i_i_fu_200 <= 1'd0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        sof_1_i_i_fu_200 <= 1'd1;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_block_pp1_stage0_11001 == 1'b0) & (1'd0 == exitcond_i_fu_467_p2) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        tmp_i_reg_661 <= {{tmp_i_i_75_reg_636[11:1]}};
    end
end

always @ (*) begin
    if (((1'd1 == exitcond3_i_i_fu_456_p2) & (1'b1 == ap_CS_fsm_state5))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((ap_condition_509 == 1'b1)) begin
        if ((1'd1 == brmerge_i_i_reg_701)) begin
            ap_phi_mux_axi_last_V_2_i_i_phi_fu_343_p4 = eol_reg_316;
        end else if ((1'd0 == brmerge_i_i_reg_701)) begin
...
always @ (*) begin
    if (((1'd0 == eol_2_i_i_reg_363) & (ap_block_pp2_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp2_iter1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if (((1'd0 == exitcond_i_reg_692) & (ap_block_pp1_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp1_iter1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((1'd0 == eol_2_i_i_reg_363) & (ap_block_pp2_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp2_iter1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'd0 == brmerge_i_i_reg_701) & (1'd0 == exitcond_i_reg_692) & (ap_block_pp1_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp1_iter1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if ((((ap_block_pp2_stage0_11001 == 1'b0) & (1'd0 == eol_2_i_i_reg_363) & (1'b1 == ap_enable_reg_pp2_iter1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((ap_block_pp1_stage0_11001 == 1'b0) & (1'b1 == ap_predicate_op72_read_state7) & (1'b1 == ap_enable_reg_pp1_iter1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((s_axis_video_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state3)))) begin
...
always @ (*) begin
    if (((1'd0 == exitcond_i_reg_692) & (ap_block_pp1_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp1_iter1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ...
        stream_in_V_val_3_V_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    if (((1'd0 == exitcond_i_reg_692) & (ap_block_pp1_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp1_iter1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ...
        stream_in_V_val_4_V_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    if (((1'd0 == exitcond_i_reg_692) & (ap_block_pp1_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp1_iter1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ...
        stream_in_V_val_5_V_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'd0 == tmp_user_V_fu_428_p1) & (s_axis_video_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else if (((1'd1 == tmp_user_V_fu_428_p1) & (s_axis_video_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((1'b1 == ap_enable_reg_pp1_iter1) & (((1'b0 == s_axis_video_V_data_V_0_vld_out) & (1'b1 == ap_predicate_op72_read_state7)) | ((1'd0 == exitcond_i_reg_692) & (1'b0 == stream_in_V_val_0_V1_status))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((1'b1 == ap_enable_reg_pp1_iter1) & (((1'b0 == s_axis_video_V_data_V_0_vld_out) & (1'b1 == ap_predicate_op72_read_state7)) | ((1'd0 == exitcond_i_reg_692) & (1'b0 == stream_in_V_val_0_V1_status))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((1'b1 == ap_enable_reg_pp1_iter1) & (((1'b0 == s_axis_video_V_data_V_0_vld_out) & (1'b1 == ap_predicate_op72_read_state7)) | ((1'd0 == exitcond_i_reg_692) & (1'b0 == stream_in_V_val_0_V1_status))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((1'd0 == eol_2_i_i_reg_363) & (1'b0 == s_axis_video_V_data_V_0_vld_out) & (1'b1 == ap_enable_reg_pp2_iter1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((1'd0 == eol_2_i_i_reg_363) & (1'b0 == s_axis_video_V_data_V_0_vld_out) & (1'b1 == ap_enable_reg_pp2_iter1));
end
...
always @ (*) begin
    ap_block_state10_pp2_stage0_iter1 = ((1'd0 == eol_2_i_i_reg_363) & (1'b0 == s_axis_video_V_data_V_0_vld_out));
end
...
always @ (*) begin
    ap_block_state2_on_subcall_done = ((1'b0 == grp_reg_unsigned_short_s_fu_422_ap_done) | (1'b0 == grp_reg_unsigned_short_s_fu_416_ap_done));
end

assign ap_block_state6_pp1_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state7_pp1_stage0_iter1 = (((1'b0 == s_axis_video_V_data_V_0_vld_out) & (1'b1 == ap_predicate_op72_read_state7)) | ((1'd0 == exitcond_i_reg_692) & (1'b0 == stream_in_V_val_0_V1_status)));
end

assign ap_block_state9_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_condition_509 = ((1'd0 == exitcond_i_reg_692) & (ap_block_pp1_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp1_iter1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_i_i_reg_338 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_351 = 'bx;

always @ (*) begin
    ap_predicate_op72_read_state7 = ((1'd0 == brmerge_i_i_reg_701) & (1'd0 == exitcond_i_reg_692));
end

assign brmerge_i_i_fu_481_p2 = (sof_1_i_i_fu_200 | ap_phi_mux_eol_i_i_phi_fu_297_p4);

assign exitcond3_i_i_fu_456_p2 = ((i_i_i_reg_282 == tmp_i_i_reg_631) ? 1'b1 : 1'b0);

assign exitcond_i_fu_467_p2 = ((j_i_i_reg_305 == tmp_i_reg_661) ? 1'b1 : 1'b0);

assign grp_reg_unsigned_short_s_fu_416_ap_start = ap_reg_grp_reg_unsigned_short_s_fu_416_ap_start;

assign grp_reg_unsigned_short_s_fu_416_in_r = HwReg_height[11:0];

assign grp_reg_unsigned_short_s_fu_422_ap_start = ap_reg_grp_reg_unsigned_short_s_fu_422_ap_start;

assign grp_reg_unsigned_short_s_fu_422_in_r = HwReg_width[11:0];

assign i_fu_461_p2 = (i_i_i_reg_282 + 12'd1);

assign j_fu_472_p2 = (j_i_i_reg_305 + 11'd1);

assign pix_val_0_V_fu_492_p4 = {{ap_phi_mux_p_Val2_s_phi_fu_355_p4[23:16]}};

assign pix_val_1_V_1_fu_502_p1 = ap_phi_mux_p_Val2_s_phi_fu_355_p4[7:0];

assign pix_val_2_V_fu_506_p4 = {{ap_phi_mux_p_Val2_s_phi_fu_355_p4[15:8]}};

assign pix_val_3_V_fu_516_p4 = {{ap_phi_mux_p_Val2_s_phi_fu_355_p4[47:40]}};

assign pix_val_4_V_1_fu_526_p4 = {{ap_phi_mux_p_Val2_s_phi_fu_355_p4[31:24]}};

assign pix_val_5_V_fu_536_p4 = {{ap_phi_mux_p_Val2_s_phi_fu_355_p4[39:32]}};
...
assign sel_tmp1_i_fu_546_p3 = ((sel_tmp_i_fu_441_p2[0:0] === 1'b1) ? pix_val_3_V_fu_516_p4 : pix_val_5_V_fu_536_p4);

assign sel_tmp2_i_fu_446_p2 = ((HwReg_InVideoFormat == 8'd0) ? 1'b1 : 1'b0);

assign sel_tmp5_i_fu_561_p3 = ((sel_tmp_i_fu_441_p2[0:0] === 1'b1) ? pix_val_5_V_fu_536_p4 : pix_val_4_V_1_fu_526_p4);

assign sel_tmp9_i_fu_576_p3 = ((sel_tmp_i_fu_441_p2[0:0] === 1'b1) ? pix_val_4_V_1_fu_526_p4 : pix_val_0_V_fu_492_p4);

assign sel_tmp_i_fu_441_p2 = ((HwReg_InVideoFormat == 8'd1) ? 1'b1 : 1'b0);

assign stream_in_V_val_0_V1_status = (stream_in_V_val_5_V_full_n & stream_in_V_val_4_V_full_n & stream_in_V_val_3_V_full_n & stream_in_V_val_2_V_full_n & stream_in_V_val_1_V_full_n & stream_in_V_val_0_V_full_n);

assign stream_in_V_val_0_V_din = ((sel_tmp2_i_fu_446_p2[0:0] === 1'b1) ? pix_val_0_V_fu_492_p4 : pix_val_1_V_1_fu_502_p1);

assign stream_in_V_val_0_V_write = stream_in_V_val_0_V1_update;

assign stream_in_V_val_1_V_din = ((sel_tmp2_i_fu_446_p2[0:0] === 1'b1) ? pix_val_1_V_1_fu_502_p1 : pix_val_2_V_fu_506_p4);

assign stream_in_V_val_1_V_write = stream_in_V_val_0_V1_update;

assign stream_in_V_val_2_V_din = ((sel_tmp2_i_fu_446_p2[0:0] === 1'b1) ? pix_val_2_V_fu_506_p4 : pix_val_0_V_fu_492_p4);

assign stream_in_V_val_2_V_write = stream_in_V_val_0_V1_update;

assign stream_in_V_val_3_V_din = ((sel_tmp2_i_fu_446_p2[0:0] === 1'b1) ? pix_val_3_V_fu_516_p4 : sel_tmp9_i_fu_576_p3);

assign stream_in_V_val_3_V_write = stream_in_V_val_0_V1_update;

assign stream_in_V_val_4_V_din = ((sel_tmp2_i_fu_446_p2[0:0] === 1'b1) ? pix_val_4_V_1_fu_526_p4 : sel_tmp5_i_fu_561_p3);

assign stream_in_V_val_4_V_write = stream_in_V_val_0_V1_update;

assign stream_in_V_val_5_V_din = ((sel_tmp2_i_fu_446_p2[0:0] === 1'b1) ? pix_val_5_V_fu_536_p4 : sel_tmp1_i_fu_546_p3);

assign stream_in_V_val_5_V_write = stream_in_V_val_0_V1_update;

assign tmp_user_V_fu_428_p1 = s_axis_video_V_user_V_0_data_out;

endmodule //bd_039a_csc_0_AXIvideo2MultiPixStr
