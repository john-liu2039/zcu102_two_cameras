...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = mipi_csi2_rx0_mipi_csi2_rx_subsystem_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_demosaic
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mipi_csi2_rx0_v_demosaic_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = mipi_csi2_rx0_v_frmbuf_wr_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_gamma_lut
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mipi_csi2_rx0_v_gamma_lut_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 2.4
 PARAMETER HW_INSTANCE = mipi_csi2_rx0_v_proc_ss_csc
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 2.4
 PARAMETER HW_INSTANCE = mipi_csi2_rx0_v_proc_ss_scaler
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipicsiss
 PARAMETER DRIVER_VER = 1.1
 PARAMETER HW_INSTANCE = mipi_csi2_rx1_mipi_csi2_rx_subsystem_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_demosaic
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mipi_csi2_rx1_v_demosaic_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = mipi_csi2_rx1_v_frmbuf_wr_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_gamma_lut
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mipi_csi2_rx1_v_gamma_lut_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 2.4
 PARAMETER HW_INSTANCE = mipi_csi2_rx1_v_proc_ss_csc
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 2.4
 PARAMETER HW_INSTANCE = mipi_csi2_rx1_v_proc_ss_scaler
END
...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 3.4
 PARAMETER HW_INSTANCE = sensor0_iic
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.4
 PARAMETER HW_INSTANCE = sensor1_iic
END
